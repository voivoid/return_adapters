...
using safe_com_throwing_handler =
    throwing::generic_adapter_handler<is_hresult_succeeded_predicate,
                                      throwing::generic_exception_factory<hresult_str_exception_formatter, std::runtime_error>>;
