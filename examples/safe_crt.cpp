...
constexpr auto ferror  = retval::adapt<::ferror, retval::adapter_to_optional<check_retval_is_not_zero>>();
constexpr auto fflush  = RETURN_ADAPTERS_ADAPT_TO_THROWING( ::fflush, safe_crt_throwing_handler<check_retval_is_zero> );
constexpr auto fgetc   = retval::adapt<::fgetc, retval::adapter_to_optional<check_retval_is_not_<EOF>>>();
